...
<body>
		...
		<div class="list_nav">
			<span><a href="<%=basePath%>exam.jsp">错题练习</a></span>><span>${practicename }</span>
		</div>
        	...
        	<div class="contains_show">
        		...
        		<div class="contains_buttom">
        			...
        			<div class="text_content_choose">
						<span>请选择：</span>
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index}&answer_i=${1}"><button class="choose" type="button">A</button></a>
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index}&answer_i=${2}"><button class="choose" type="button">B</button></a>
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index}&answer_i=${3}"><button class="choose" type="button" id="itemdisplay3">C</button></a>
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index}&answer_i=${4}"><button class="choose" type="button" id="itemdisplay4">D</button></a>
					</div>
        		</div>
        		<div class="test_information">
        			...
        			<div class="submit_answer">					
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index-1 }&answer_i=${0}"><button class="prev">上一题</button></a>
						<a href="<%=basePath%>personal/dealerrorsubjects?control_i=${index+1 }&answer_i=${0}"><button class="next">下一题</button></a>
					</div>
        		</div>
