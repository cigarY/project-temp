...
<body>
	...
	<form action="<%=basePath%>user/doadminlogin" method="post">
	<div class="content">
		<div class="content_show">
				...
				<div class="login_box">
					<div class="login_box_show">
						...
						<div class="name"><input type="text" name="adminname" placeholder="用户名"></div>
						<div class="pwd"><input type="password" name="adminpwd" placeholder="密码"></div>
