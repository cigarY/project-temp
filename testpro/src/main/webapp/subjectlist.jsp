...
<body>
	<center>
		...
		<form action="<%=basePath%>subject1/getkeywordsubjects" method="post">
			<input type="text" name="key" value="${keyWords}" /> <input
		...
		<table border="1" cellpadding="0" cellspacing="0" align="center"
			...
			<tr>
				<td colspan="11" align="center"><a href="<%=basePath%>subject1/getallsubjects?pageNo=${1}">首页</a> <a
					href="<%=basePath%>subject1/getallsubjects?pageNo=${pageNo-1}">上一页</a> <a
					href="<%=basePath%>subject1/getallsubjects?pageNo=${pageNo+1}">下一页</a>
