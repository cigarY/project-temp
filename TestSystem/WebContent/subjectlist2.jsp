...
<center>
	<h3>题目列表</h3>
	<form action="subjectlist2" method="post">
	<input type="text" name="key" value="${key }"/>
	<input type="submit" value="查询" />&nbsp;<a href="subjectadd2" target="myIframe">添加题目</a>
	</form>
	<table border="1" cellpadding="0" cellspacing="0" align="center" width="940px">
		...
		<tr>
			<td style="height: 30px; width: 100px">
				<a href="subjectedit2?id=${subject.id }" target="myIframe">编辑</a>
				<a href="subjectdelete2?id=${subject.id }" onclick="return confirmDel();">删除</a>
			</td>
			<td>${subject.id }</td>
